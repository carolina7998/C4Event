...
if ($evento_query->num_rows > 0) {
    ...
    if ($servicios_query->num_rows > 0) {
        ...
        while ($servicio = $servicios_query->fetch_assoc()) {
            ...
            $pdf->Cell(35, $cellHeight, number_format($servicio['valor_unitario'], 2), 0, 0, 'C');
            $pdf->Cell(40, $cellHeight, number_format($servicio['valor_adicional'], 2), 0, 0, 'C');
            $pdf->Cell(40, $cellHeight, number_format($precio_total, 2), 0, 1, 'C');
        ...
        if ($update_iva_query) {
            ...
            $pdf->SetFont('Arial', '', 12);
            $pdf->Cell(40, 7, number_format($iva, 2), 0, 1, 'R');
