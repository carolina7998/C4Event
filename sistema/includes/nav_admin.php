          ...
          <ul class="navbar-nav d-flex justify-content align-items-center">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="comentario.php">Comentarios</a></li>
                  <li><a class="dropdown-item" href="cotizaciones.php">Cotizaciones</a></li>
                </ul>
              </li>
              <!--<li class="nav-item">
             ...
             <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="comentario.php">Comentarios</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="cotizaciones.php">Cotizaciones</a>
              </li>-->
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="estadisticass.php">Estadísticas</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="fechas_reservadas.php">Calendario</a>
              </li>
